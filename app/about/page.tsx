        ...
        <main className="flex flex-col gap-7 container text-xl p-8 mx-auto max-w-6xl md:gap-10">
            <section className="flex flex-1 flex-col md:flex-row gap-6 md:gap-20">
                ...
                <div className="flex flex-col justify-between items-start gap-7">
                    ...
                    <h1 className="text-4xl md:text-5xl leading-none">Empowering makers worldwide</h1>
            ...
            <section className="flex flex-col gap-6 md:flex-row md:mx-auto max-w-5xl" aria-labelledby="key-features">
                ...
                <Features title="100K+ Models" text="Access our vast library of community-created 3D models, from practical tools to artistic creations.">
                    <Stack className="w-9" />
                </Features>
                <p className="hidden border-l border-gray-500 md:inline"></p>
                <Features title="Active Community" text="Join thousands of makers who share tips, provide feedback, and collaborate on projects.">
                    <Globe className="w-9" />
                </Features>
                <p className="hidden border-l border-gray-500 md:inline"></p>
                <Features title="Free to Use" text="Most models are free to download, with optional premium features for power users.">
                    <Flag className="w-9" />
                </Features>
            </section>
            <hr className="border-gray-300" aria-hidden="true" />
            <section className="flex flex-col justify-center gap-6 mx-auto max-w-3xl" >
                ...
                <Watermark className="hidden md:block place-self-center mt-10 h-25" />
            </section>
        </main>
    )
}